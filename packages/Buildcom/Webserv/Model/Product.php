...
class Buildcom_Webserv_Model_Product extends Buildcom_Webserv_Model_Abstract
{
     ...
     */
    const ENTITY                 = 'webserv_product';

    const CACHE_TAG              = 'webserv_product';
    protected $_cacheTag         = 'webserv_product';
    protected $_eventPrefix      = 'webserv_product';
    ...
    {
        $this->_init('Buildcom_Webserv_Model_Resource_Product');
    }
